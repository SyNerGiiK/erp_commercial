        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _buildItem(
                    context, 0, "Tableau de Bord", Icons.dashboard, '/home'),
                const Divider(),
                _buildItem(context, 1, "Devis", Icons.description, '/devis'),
                _buildItem(context, 2, "Factures", Icons.euro, '/factures'),
                _buildItem(context, 3, "Clients", Icons.people, '/clients'),
                _buildItem(
                    context, 4, "Planning", Icons.calendar_month, '/planning'),
                const Divider(),
                _buildItem(
                ...
                const Divider(),
                _buildItem(
                    context, 9, "Paramètres", Icons.settings, '/settings'),
                _buildItem(context, 10, "Archives", Icons.archive, '/archives'),
              ],
            ),
          ),
          ListTile(
